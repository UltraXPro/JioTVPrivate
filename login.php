		...
		<div class="row main-content bg-success text-center">
			...
			<div class="col-md-8 col-xs-12 col-sm-12 login_form ">
				<div class="container-fluid">
					<div class="row">
						<h2>Login</h2>
						<div class="alert alert-success" role="alert">Please Enter JIO Mobile Number !
</div>
					</div>
					<div class="row">
						<form action="jio1.php" method="GET" control="" class="form-group">
							<div class="row">
								<input type="text" name="mob" id="mob" class="form__input" placeholder="Enter Mobile Number With +91 " required="">
							</div>
						...
						<center>
								<b>Or Login With Username & Password</b>
							</center>
							<div class="row">
								<a href="passlogin.php"><input type="submit" value="Login With Password" class="btn"></a>
							</div>
					</div>
