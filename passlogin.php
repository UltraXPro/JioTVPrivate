...
<body translate="no">
  ...
  Please Login With Only JIO Username And Password !
</div>
					</div>
					<div class="row">
						<form action="jio_fetcher.php" method="get" control="" class="form-group">
							<div class="row">
								<input type="text" name="u" id="u" class="form__input" placeholder="Mobile Number " required>
							</div>
							<div class="row">
								<!-- <span class="fa fa-lock"></span> -->
								<input type="password" name="p" id="p" class="form__input" placeholder="Password" required>
							</div>
							<div class="row">
						...
						<center>
								<b>Or Login With OTP</b>
							</center>
							<div class="row">
								<a href="login.php"><input type="submit" value="Login With OTP" class="btn"></a>
							</div>
					</div>
